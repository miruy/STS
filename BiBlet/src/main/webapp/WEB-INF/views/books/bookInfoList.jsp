            ...
            $("#search").click(function () {	//검색 버튼 클릭시 ajax실행
                ...
                .done(function (msg) {	//검색 결과 담기 / [응답]
                    ...
                    for (var i = 0; i < 10; i++){
                        ...
                        $("div").append("<h2><a href='${pageContext.request.contextPath}/AppraisalPage/read/"+ msg.documents[i].isbn.slice(0, 10)+"?isbn="+msg.documents[i].isbn.slice(0, 10) +"&query="+$("#query").val()+"'>" + msg.documents[i].title + "</a></h2>");	//제목
